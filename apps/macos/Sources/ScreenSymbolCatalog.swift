...
/// Names from Apple SF Symbols 7.2 name_availability.plist (September 2026).
/// Only names are bundled; artwork is provided by the OS through public AppKit APIs.
/// Filter once per launch so macOS 14+ never offers symbols it cannot render.
@MainActor
enum ScreenSymbolCatalog {
    static let available = names.filter { NSImage(systemSymbolName: $0, accessibilityDescription: nil) != nil }
    static let names = [
        "0.circle",
        "0.circle.ar",
        "0.circle.fill",
